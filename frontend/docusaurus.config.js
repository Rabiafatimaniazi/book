...
// to scan the JS code and provide more helpful autocompletion
...
const config = {
  ...
  url: 'https://your-textbook-domain.vercel.app',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/your-username/physical-ai-textbook/tree/main/packages/create-docusaurus/templates/shared/',
        },
  ...
  // plugins: [
  //   // Plugin to add custom API endpoints for our textbook
  //   [
  //     '@docusaurus/plugin-content-docs',
  //     {
  //       id: 'chapters',
  //       path: 'static/textbook-content/chapters',
